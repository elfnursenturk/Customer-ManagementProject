    ...
    const onSubmit = (event) => {
        ...
        axios.post(
            ...
            .then((response) => {
                ...
                setSuccessMessage("Customer is created!");
            })
            .catch((error) => {
                ...
                <form className="card" onSubmit={onSubmit}>
                    ...
                    <div className="card-body">
                        ...
                        <div className="mb-3">
                            ...
                            />
                            {errors['customer.firstName'] && <div style={{ color: "red", fontSize: "12px" }}>{errors['customer.firstName']}</div>}
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            />
                            {errors['customer.lastName'] && <div style={{ color: "red", fontSize: "12px" }}>{errors['customer.lastName']}</div>}
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            />
                            {errors['customer.tckn'] && <div style={{ color: "red", fontSize: "12px" }}>{errors['customer.tckn']}</div>}
                        </div>
                        ...
                        <div className="text-center">
                            <button className="btn btn-outline-primary"
                                type="submit"
                                disabled={apiProgress}> Sign Up</button>
                        </div>
                    </div>
                </form>
            </div>
